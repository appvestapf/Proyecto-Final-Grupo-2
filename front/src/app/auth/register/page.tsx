      ...
      <div className="flex items-center justify-center p-6 sm:p-8 bg-surface">
        <div className="max-w-md w-full space-y-3">
          <div className="text-center lg:text-left">
            <h1 className="text-3xl font-bold text-main tracking-tight">Creá tu cuenta</h1>
            <p className="text-sm text-muted mt-2">Completá tus datos para empezar a operar</p>
          </div>
          ...
          <div className="flex items-center my-3">
            ...
            <span className="px-3 text-xs text-muted uppercase tracking-wider">o con tus datos</span>
            <div className="flex-grow border-t border-subtle"></div>
          </div>

          <form onSubmit={handleSubmit(onSubmit)} className="space-y-3">
            <div>
              <label className="block text-[13px] font-medium text-main mb-1">Nombre completo</label>
              <input
                type="text"
                autoComplete="name"
                {...register('name')}
                className={`w-full px-4 py-2 bg-app/50 border rounded-[12px] focus:outline-none focus:ring-2 text-sm text-main placeholder:text-muted transition-all ${
                  errors.name ? 'border-red-500 focus:ring-red-500/20' : 'border-subtle focus:border-primary focus:ring-primary/20'
                }`}
            ...
            <div>
              <label className="block text-[13px] font-medium text-main mb-1">Dirección</label>
              <input
                type="text"
                autoComplete="street-address"
                {...register('address')}
                className={`w-full px-4 py-2 bg-app/50 border rounded-[12px] focus:outline-none focus:ring-2 text-sm text-main placeholder:text-muted transition-all ${
                  errors.address ? 'border-red-500 focus:ring-red-500/20' : 'border-subtle focus:border-primary focus:ring-primary/20'
                }`}
            ...
            <div>
              <label className="block text-[13px] font-medium text-main mb-1">Contraseña</label>
            ...
            <div>
              <label className="block text-[13px] font-medium text-main mb-1">Confirmar contraseña</label>
              <input
                type={showPassword ? 'text' : 'password'}
                autoComplete="new-password"
